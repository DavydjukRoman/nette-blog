<?php
// source: C:\Users\davyd\Documents\PhpstormProjects\nette-blog\app/config/common.neon
// source: C:\Users\davyd\Documents\PhpstormProjects\nette-blog\app/config/local.neon
// source: array
...
class Container_0dad6bde15 extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'ArrayAccess' => [2 => ['routing.router', 'application.1', 'application.3']],
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\Users\davyd\Documents\PhpstormProjects\nette-blog\app/../temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\Users\davyd\Documents\PhpstormProjects\nette-blog\app/../temp/cache/journal.s3db');
	}
	...
	public function createServiceContainer(): Container_0dad6bde15
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_0dad6bde15 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\davyd\Documents\PhpstormProjects\nette-blog\app/../temp/cache/latte');
